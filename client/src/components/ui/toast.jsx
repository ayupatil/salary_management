...
function Toast({ message, variant, onClose }) {
  ...
  const icons = {
    success: <Icon icon="carbon:checkmark-outline" width="20" height="20" />,
    error: <Icon icon="carbon:close-outline" width="20" height="20" />,
    info: <Icon icon="carbon:information" width="20" height="20" />,
    warning: <Icon icon="carbon:warning-alt" width="20" height="20" />,
  };
